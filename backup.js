...
class App extends React.Component {
  constructor(props) {
    super(props);
    //key+url doesn't need to be in state, break out by functionality
    //pull out key and base url and key as constants inside an object, pass it down separately in props to child component as a separate prop from limit rating and lang
    this.state = {
      query: "",
      queryError: "",
      executedQuery: "",
    ...
    //run arrow functions by mark again
